...
popUpWin = open(URLStr,'popUpWin', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=yes,width='+510+',height='+430+',left='+left+', top='+top+',screenX='+left+',screenY='+top+'');
      ...
      <title>Seemilar | Dashboard | My Profile</title>
...
<body style="padding-top: 100px;"> <!--body begins here-->
      ...
      <div class="row decor_bg">
                <div class="col-md-6 col-md-offset-3">
                   ...
                   <a href="javascript:void(0);"  class="btn btn-primary btn-lg" onClick="popUpWindow('http://localhost:8080/ProjectWork/print_profile.jsp');" role="button" title="View Full Details">Go to Print</a>
                </div>            
            </div>
